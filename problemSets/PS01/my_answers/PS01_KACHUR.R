...
# Task 2:  
# Hypothesis testing, one sided hypothesis test. School mean IQ < 100.  
...
# "North Central" has the lowest spending. 
...
# Answer: There appears to be a positive relationship (correlation) between Y
# and X1. 
